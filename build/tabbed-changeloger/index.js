...
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"cha/tabbed-changeloger","version":"0.1.0","title":"Tabbed Changeloger","category":"widgets","icon":"smiley","description":"A tabbed interface for displaying multiple changelogs.","example":{},"attributes":{"activeTab":{"type":"number","default":0},"tabs":{"type":"array","default":[{"title":"Tab 1","id":"tab-1"}]},"tabAlignment":{"type":"string","default":"left"}},"supports":{"html":false},"providesContext":{"cha/activeTab":"activeTab","cha/tabs":"tabs"},"textdomain":"tabbed-changeloger","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"tabbed-changeloger","viewScript":"tabbed-changeloger-frontend"}');
...
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./editor.scss */ "./src/tabbed-changeloger/editor.scss");
...
function Edit({
  ...
  const [selectedTab, setSelectedTab] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useState)(activeTab || 0);
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.PanelBody, {
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__.__)('Tab Alignment', 'changeloger')
    ...
    className: `tabs-header ${getAlignmentClass()}`
    ...
    className: "tab-title"
  }, tab.title), tabs.length > 1 && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.Button, {
...
function save({
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    className: `tabs-header ${getAlignmentClass()}`
  }, tabs && tabs.map((tab, index) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("button", {
    key: tab.id,
