    ...
    public function render_page() {
        ...
        if ( isset( $_POST['cha_trigger_cron'] ) && check_admin_referer( 'cha_trigger_cron' ) ) {
            if ( function_exists( 'cha_run_daily_version_check' ) ) {
                ...
                echo '<div class="notice notice-error"><p>' . esc_html__( 'Auto check function not found. Make sure version-notification-cron.php is loaded.',
                                'changeloger' ) . '</p></div>';
            }
        }
                ...
                <table class="widefat">
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if ( $cron_timestamp ) : ?>
                                <?php
                                $next_run = $cron_timestamp > time()
                                        ? __( 'in', 'changeloger' ) . ' ' . $cron_status
                                        : $cron_status . ' ' . __( 'ago', 'changeloger' );
